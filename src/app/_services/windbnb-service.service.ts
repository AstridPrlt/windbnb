...
import { ApiAirbnbResults } from '../_models/api-airbnb-results.model';

@Injectable({
  providedIn: 'root'
})
export class WindbnbServiceService {
  apiUrl: string = "https://public.opendatasoft.com/api/v2/catalog/datasets/airbnb-listings/records?where=city+like+%22paris%22&limit=100&offset=0&timezone=UTC&include_app_metas=False";
  ...
  getApiListing(): Observable<ApiAirbnbResults> {
    return this.http.get<ApiAirbnbResults>(this.apiUrl);
  }
}
